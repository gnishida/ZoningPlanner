...
Person::Person() : _type(TYPE_UNKNOWN), commuteTo(-1) {
	initPreference();
}

Person::Person(int type, const QVector2D& homeLocation) : _type(type), homeLocation(homeLocation), commuteTo(-1) {
	initPreference();
}
...
void Person::initPreference() {
	...
	if (_type == TYPE_STUDENT) {
		if (r < 0.333) { // outdoor life
			preference[0] = 0; preference[1] = 0; preference[2] = 0.15; preference[3] = 0.15; preference[4] = 0.5; preference[5] = 0; preference[6] = 0.1; preference[7] = 0.1;
			...
			preference[0] = 0; preference[1] = 0; preference[2] = 0.05; preference[3] = 0; preference[4] = 0.6; preference[5] = 0; preference[6] = 0.25; preference[7] = 0.1;
		}
		...
		if (r < 0.3) { // men with kids
			preference[0] = 0.05; preference[1] = 0; preference[2] = 0.1; preference[3] = 0.2; preference[4] = 0.4; preference[5] = 0; preference[6] = 0.1; preference[7] = 0.15;
		} else if (r < 0.6) { // women with kids
			preference[0] = 0.15; preference[1] = 0.1; preference[2] = 0; preference[3] = 0.15; preference[4] = 0.2; preference[5] = 0.1; preference[6] = 0.1; preference[7] = 0.2;
		} else { // no kid
			preference[0] = 0.2; preference[1] = 0; preference[2] = 0.25; preference[3] = 0; preference[4] = 0.35; preference[5] = 0; preference[6] = 0.1; preference[7] = 0.1;
		}
