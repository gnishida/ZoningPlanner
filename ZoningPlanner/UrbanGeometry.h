...
public:
	...
	void findBestPlan(VBORenderManager& renderManager, std::vector<std::vector<float> >& preference, int zoning_start_size, int zoning_num_layers, int mcmc_steps, float upscale_factor);
